...
import { DynoRun, coverImageSrc } from '@/services/dynoRunService';
        ...
        >
            <div className="aspect-video bg-gray-100 relative overflow-hidden">
                {cover ? (
                    ...
                    <img src={cover} alt={run.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform" />
                ) : (
